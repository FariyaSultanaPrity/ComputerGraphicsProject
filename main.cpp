...
void house()
{
	...
	//Building block 1
        ...
        //Building block 1 window 1 and 2
        ...
        //Building block 1 second floor border
        ...
        //Building block 2 second floor

        glColor3f (1.0, 0.0, 0.0);
        glVertex2f(150, 260);
        glVertex2f(200, 275);
        glVertex2f(200, 342.5);
        glVertex2f(150, 330);

        //Building block 2 second floor border
        ...
        //Building first floor upper border
